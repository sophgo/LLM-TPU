...
void CodeFuse::head_launch(const bm_net_info_t *net,
...
int CodeFuse::greedy_search(const bm_net_info_t *net,
                            bm_device_mem_t &logits_mem) {
...
int CodeFuse::penalty_sample(const bm_net_info_t *net,
                             bm_device_mem_t &logits_mem) {
