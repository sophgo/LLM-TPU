...
pip3 install sentencepiece transformers==4.42.3
...
# python demo
```
python3 pipeline.py --model_path llama3.1-8b_int8_1dev_seq512.bmodel --tokenizer_path ../support/token_config/ --devid 0 --generation_mode greedy
```
