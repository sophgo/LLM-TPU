...
pip3 install transformers_stream_generator einops tiktoken accelerate transformers==4.31.0
...
# python demo
```
python3 pipeline.py --model_path qwen-vl-chat-combine.bmodel --tokenizer_path ./supports/token_config/ --devid 0 --generation_mode greedy
```

# web demo
```
streamlit run qwen_vl_web_demo.py 
```
