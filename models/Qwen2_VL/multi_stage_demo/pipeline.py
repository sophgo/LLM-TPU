...
class Model:
    def __init__(self, args):
        ...
        self.tokenizer_path = os.path.join(args.config, "tokenizer")
        self.embedding_path = os.path.join(args.config, "embedding.bin")
        ...
        # seq_len param
        self.seq_length_list = [1100,800,1500]
        self.input_length_list = [960,420,1400]
    ...
    def map(self, args):
        ...
        # VISION
            ...
            processor_path = os.path.join(args.config, "processor")
    ...
    def get_seq_index(self, in_length):
        seq_index = []
        for index, i_length in enumerate(self.input_length_list):
            if i_length >= in_length:
    ...
    def prefill_phase(self, text, media_path, media_type):
        ...
        # self.model.stage_idx = self.get_seq_index(len(tokens))[-1]
...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", "--config", type=str, required=True,
