...
if [ "$name" = "phi3-4b" ]; then
  num_layers=31
  hidden_size=3072
  echo "Compile Phi3-4B"
else
  >&2 echo -e "Error: Invalid name $name, the input name must be \033[31mphi3-4b\033[0m"
  exit 1
fi
...
model_tool --combine $models intern_vit_1684x_f16.bmodel -o $out_model
