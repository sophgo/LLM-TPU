...
# E2B BM1684X
pip3 install dfss
python3 -m dfss --url=open@sophgo.com:/ext_model_information/LLM/LLM-TPU/gemma-4-e2b-it-awq-4bit_w4f16_seq4096_bm1684x_1dev_static_20260521_093339.bmodel
# E4B BM1684X
...
# E2B BM1488
python3 -m dfss --url=open@sophgo.com:/ext_model_information/LLM/LLM-TPU/gemma-4-e2b-it-awq-4bit_w4f16_seq4096_bm1688_2core_static_20260521_205844.bmodel
```
...
```bash
# E2B 
llm_convert.py -m gemma-4-E2B-it -s 4096 --max_input_length 2560 -q w4f16 -c bm1684x -o bmodel/ --audio_length 750

# E4B
llm_convert.py -m gemma-4-E4B-it -s 4096 --max_input_length 2560 -q w4f16 -c bm1684x -o bmodel/ --audio_length 750
```
...
- `-o`: 输出目录
- `--audio_length`: 音频最大 token 数，默认 200
...
```bash
python3 pipeline.py -m your_bmodel_path -c ../config -d 0
```
...
**音频理解：**
```
Question: Transcribe the following speech segment in its original language.
Image, Video, or Audio Path: asr_en.wav
```