...
void Llama3::head_launch(const bm_net_info_t *net,
...
int Llama3::greedy_search(const bm_net_info_t *net,
                          bm_device_mem_t &logits_mem) {
...
int Llama3::penalty_sample(const bm_net_info_t *net,
                           bm_device_mem_t &logits_mem) {
