...
void Megrez::net_launch(const bm_net_info_t *net, int stage_idx) {
...
void Megrez::d2d(bm_device_mem_t &dst, bm_device_mem_t &src) {
  bm_memcpy_d2d_byte(bm_handle, dst, 0, src, 0, bm_mem_get_device_size(src));
}

void Megrez::init(int dev_id, std::string model_path) {
...
int Megrez::forward_first(std::vector<int> &tokens) {
...
PYBIND11_MODULE(chat, m) {
  pybind11::class_<Megrez>(m, "Megrez")
      .def(pybind11::init<>())
      .def("init", &Megrez::init)
      .def("forward_first", &Megrez::forward_first)
      .def("forward_next", &Megrez::forward_next)
      .def("deinit", &Megrez::deinit)
      .def_readwrite("SEQLEN", &Megrez::SEQLEN) // read SEQLEN in pipeline.py
      .def_readwrite("token_length", &Megrez::token_length);
}