...
module @lm_head attributes {module.FLOPs = 1090012676 : i64, module.chip = "ALL", module.platform = "TORCH", module.state = "TOP_F32", module.top_run_mode = "STATIC", module.weight_file = "lm_head_top_f32_all_weight.npz"} {
  func.func @main(%arg0: tensor<1x{hidden_size}xf32> loc(unknown)) -> tensor<1x1xf32> {
    %0 = "top.None"() : () -> none loc(#loc)
    %1 = "top.Input"(%arg0) {do_preprocess = false} : (tensor<1x{hidden_size}xf32>) -> tensor<1x{hidden_size}xf32> loc(#loc1)
    ...
    %values, %indices = "top.TopK"(%5) {K = 1 : i64, axis = 1 : i64, largest = true, replace_topk_indices = false, sorted = true} : (tensor<1x{vocab_size}xf32>) -> (tensor<1x1xf32>, tensor<1x1xf32>) loc(#loc8)
