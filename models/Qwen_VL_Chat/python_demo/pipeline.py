...
================================================================="""
    ...
    def stream_answer(self, tokens):
        ...
        images_list = images.flatten().tolist()
        token = self.model.forward_first(ids, images_list, begin.item(), end.item())
        breakpoint()
        first_end = time.time()
        # Following tokens
    ...
    # For Qwen-VL-Chat web
    def chat_stream(self, prompt, image, history):
        """
        Stream the answer for the given tokens.
        """
        tok_num = 0
