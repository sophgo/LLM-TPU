...
# python demo
```
python3 pipeline.py --model_path llama2-7b_int4_1dev.bmodel --tokenizer_path ../support/token_config/ --devid 0 --generation_mode greedy
```

# web demo
```
python3 web_demo.py --model_path llama2-7b_int4_1dev.bmodel --tokenizer_path ../support/token_config/ --devid 0
```
