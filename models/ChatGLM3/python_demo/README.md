...
# python demo
```
python3 pipeline.py --model_path chatglm3-6b_int4_1dev_seq512.bmodel --tokenizer_path ../support/token_config/ --devid 0 --generation_mode greedy
```

# web demo
```
python3 web_demo.py --model_path chatglm3-6b_int4_1dev_seq512.bmodel --tokenizer_path ../support/token_config/ --devid 0
```
