...
class Qwen2():
    def __init__(self, args):
        ...
        self.model = chat_without_assert.Qwen()
...
================================================================="""
    ...
    def check_status(self):
        if self.model.status_code == -1:
            print("Error: Model is not loaded, please check the create of handle or bmrt")
        elif self.model.status_code == -2:
            print("Error: Model is not loaded, please check the bmodel or key")
        else:
    ...
    def test_ceval(self):
        ...
        if self.model.status_code == 0:
            self.stream_answer(self.encode_tokens())
