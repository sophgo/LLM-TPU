...
class VisionTransformer(torch.nn.Module):
    ...
    def __init__(self, image_grid_thw):
        super().__init__()
        self.rotary_pos_emb = ViT.rot_pos_emb(image_grid_thw)
        self.cu_seqlens = torch.repeat_interleave(image_grid_thw[:, 1] * image_grid_thw[:, 2], image_grid_thw[:, 0]).cumsum(
