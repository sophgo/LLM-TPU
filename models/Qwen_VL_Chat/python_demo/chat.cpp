...
void Qwen::init(const std::vector<int> &devices, std::string model_path) {
  ...
  net_vit = bmrt_get_network_info(p_bmrt, "qwen_vit");
...
int Qwen::forward_first(std::vector<int> &tokens, std::vector<float> &images,
                        int begin, int end) {
...
std::vector<int> Qwen::generate(std::vector<int> &history_tokens,
                                std::vector<float> &images, int begin, int end,
                                int EOS) {
