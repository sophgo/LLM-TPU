...
def convert_block(layer_id):
    ...
    torch.onnx.export(
        ...
        dynamic_axes = {
            'input_states' : {0 : 'batch_size', 1: 'q_len'},
            'position_ids': {0 : 'batch_size', 1: 'q_len'},
            'attention_mask': {2: 'q_len', 3: 'v_len'},
            'hidden_states': {0 : 'batch_size', 1: 'q_len'},
            'past_k': {0 : 'batch_size', 1: 'q_len'},
            'past_v': {0 : 'batch_size', 1: 'q_len'},
        },
...
def convert_block_cache(layer_id):
    ...
    torch.onnx.export(
        ...
        dynamic_axes = {
            'input_states' : {0 : 'batch_size', 1: 'q_len'},
            'position_ids': {0 : 'batch_size', 1: 'q_len'},
            'attention_mask': {2: 'q_len', 3: 'cat_len'},
            'history_k': {0 : 'batch_size', 1: 'past_len'},
            'history_v': {0 : 'batch_size', 1: 'past_len'},
            'hidden_states': {0 : 'batch_size', 1: 'q_len'},
            'past_k': {0 : 'batch_size', 1: 'q_len'},
            'past_v': {0 : 'batch_size', 1: 'q_len'},
        },
