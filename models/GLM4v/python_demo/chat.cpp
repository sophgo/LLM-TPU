...
template <typename T>
void dump_tensor_to_file(bm_handle_t &handle, bm_device_mem_t &t,
...
public:
  ...
  int forward_first(std::vector<int> &tokens, std::vector<float> &images,
                    int begin, int end);
  int forward_next();
  std::vector<int> generate(std::vector<int> &history_tokens,
                            std::vector<float> &images, int begin, int end,
                            int EOS);
...
int ChatGLM::forward_first(std::vector<int> &tokens, std::vector<float> &images,
                           int begin, int end) {
...
std::vector<int> ChatGLM::generate(std::vector<int> &history_tokens,
                                   std::vector<float> &images, int begin,
                                   int end, int EOS) {
