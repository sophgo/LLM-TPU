...
share_length_list=8320,8192,7168,6144,5120,4096,3072,2048,1024 # input length share_length
...
model_tool --encrypt -model qwen2-7b.bmodel -net block_0 -lib ./build/libcipher.so -o encrypted.bmodel
