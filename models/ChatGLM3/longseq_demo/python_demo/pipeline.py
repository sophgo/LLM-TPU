...
==========================================================="""
    ...
    def stream_answer(self, tokens):
        ...
        #     if(block_idx * self.WINDOW_SEQLEN <= token_length):
        #        token = self.model.forward_first(tokens[block_idx * self.WINDOW_SEQLEN: (block_idx+1)*self.WINDOW_SEQLEN], block_idx)
