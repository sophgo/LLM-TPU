...
void Qwen3_VL::forward_vit(const float *pixel_values,
  ...
  bm_memcpy_s2d_partial(bm_handle, vit_in0_mem, (void *)pixel_values,
                        num_pixels * sizeof(float));
  bm_memcpy_s2d_partial(bm_handle, vit_in1_mem, (void *)p_position_ids,
                        position_ids.size() * sizeof(int));
  bm_memcpy_s2d_partial(bm_handle, vit_in2_mem, (void *)p_pos_idx,
                        pos_idx.size() * sizeof(int));
  bm_memcpy_s2d_partial(bm_handle, vit_in3_mem, (void *)p_pos_weight,
