...
int Qwen::forward_first(std::vector<int> &tokens, std::vector<float> &images, int begin, int end) {
...
std::vector<int> Qwen::generate(std::vector<int> &history_tokens, std::vector<float> &images, int begin, int end, int EOS) {
